  ...
  return (
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      <motion.div
        ...
        animate="show"
        exit="hidden"
        className="hidden xl:flex absolute -bottom-2 -left-[285px]"
      >
        <Avatar />
      </motion.div>
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6 mt-5">
        <div className="flex-1 flex flex-col justify-center">
          ...
          >
            ...
            done remote work for agencies, helped local businesses, and
            collaborated on digital products for both business and private use.
          </motion.p>
